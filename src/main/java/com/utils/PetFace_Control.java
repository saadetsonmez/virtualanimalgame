...
public class PetFace_Control {
    ...
    public void bindToImageView(ImageView petImageView, Pane eyeLayer) {
        ...
        petImageView.layoutBoundsProperty().addListener((obs, oldVal, newVal) ->
                updatePosition(petImageView.localToScene(petImageView.getBoundsInLocal())));
