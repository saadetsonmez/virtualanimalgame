...
public class LoginController {
    ...
    private static final String PET_FILE_PATH = "UserManeger.json";
        ...
        try {
            ...
            for (int i = 0; i < userArray.length(); i++) {
                ...
                if (user.getString("username").equalsIgnoreCase(username) &&
                    ...
                    UserManegerService.setCurrentUser(userId);
                    UserManegerService.setPetName(pet.getString("petName"));
                    UserManegerService.setHunger(pet.getInt("hunger"));
                    UserManegerService.setFun(pet.getInt("fun"));
    ...
    private void checkAndSetUserManeger(int userId) throws IOException {
        ...
        // Kayıt yoksa sıfır hunger/fun ve yeni ad ile ekle
